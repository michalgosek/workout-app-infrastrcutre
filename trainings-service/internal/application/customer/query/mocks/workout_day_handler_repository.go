...
func (_m *WorkoutDayHandlerRepository) QueryWorkoutGroup(ctx context.Context, groupUUID string) (trainer.WorkoutGroup, error) {
...
//  - ctx context.Context
//  - groupUUID string
func (_e *WorkoutDayHandlerRepository_Expecter) QueryWorkoutGroup(ctx interface{}, groupUUID interface{}) *WorkoutDayHandlerRepository_QueryWorkoutGroup_Call {
	return &WorkoutDayHandlerRepository_QueryWorkoutGroup_Call{Call: _e.mock.On("QueryWorkoutGroup", ctx, groupUUID)}
}

func (_c *WorkoutDayHandlerRepository_QueryWorkoutGroup_Call) Run(run func(ctx context.Context, groupUUID string)) *WorkoutDayHandlerRepository_QueryWorkoutGroup_Call {
	_c.Call.Run(func(args mock.Arguments) {
