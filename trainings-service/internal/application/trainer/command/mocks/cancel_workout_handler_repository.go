...
func (_m *CancelWorkoutHandlerRepository) DeleteWorkoutGroup(ctx context.Context, groupUUID string) error {
...
// CancelWorkoutHandlerRepository_DeleteWorkoutGroup_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DeleteWorkoutGroup'
type CancelWorkoutHandlerRepository_DeleteWorkoutGroup_Call struct {
	*mock.Call
}
...
//  - ctx context.Context
//  - groupUUID string
func (_e *CancelWorkoutHandlerRepository_Expecter) DeleteWorkoutGroup(ctx interface{}, groupUUID interface{}) *CancelWorkoutHandlerRepository_DeleteWorkoutGroup_Call {
	return &CancelWorkoutHandlerRepository_DeleteWorkoutGroup_Call{Call: _e.mock.On("DeleteWorkoutGroup", ctx, groupUUID)}
}

func (_c *CancelWorkoutHandlerRepository_DeleteWorkoutGroup_Call) Run(run func(ctx context.Context, groupUUID string)) *CancelWorkoutHandlerRepository_DeleteWorkoutGroup_Call {
...
func (_c *CancelWorkoutHandlerRepository_DeleteWorkoutGroup_Call) Return(_a0 error) *CancelWorkoutHandlerRepository_DeleteWorkoutGroup_Call {
	_c.Call.Return(_a0)
	return _c
}
