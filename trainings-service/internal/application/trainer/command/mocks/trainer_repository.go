...
func (_m *TrainerRepository) DeleteTrainerWorkoutGroup(ctx context.Context, trainerUUID string, groupUUID string) error {
...
// TrainerRepository_DeleteTrainerWorkoutGroup_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DeleteTrainerWorkoutGroup'
type TrainerRepository_DeleteTrainerWorkoutGroup_Call struct {
	*mock.Call
}
...
//  - trainerUUID string
//  - groupUUID string
func (_e *TrainerRepository_Expecter) DeleteTrainerWorkoutGroup(ctx interface{}, trainerUUID interface{}, groupUUID interface{}) *TrainerRepository_DeleteTrainerWorkoutGroup_Call {
	return &TrainerRepository_DeleteTrainerWorkoutGroup_Call{Call: _e.mock.On("DeleteTrainerWorkoutGroup", ctx, trainerUUID, groupUUID)}
}

func (_c *TrainerRepository_DeleteTrainerWorkoutGroup_Call) Run(run func(ctx context.Context, trainerUUID string, groupUUID string)) *TrainerRepository_DeleteTrainerWorkoutGroup_Call {
...
func (_c *TrainerRepository_DeleteTrainerWorkoutGroup_Call) Return(_a0 error) *TrainerRepository_DeleteTrainerWorkoutGroup_Call {
	_c.Call.Return(_a0)
	return _c
}

// DeleteTrainerWorkoutGroups provides a mock function with given fields: ctx, trainerUUID
func (_m *TrainerRepository) DeleteTrainerWorkoutGroups(ctx context.Context, trainerUUID string) error {
...
// TrainerRepository_DeleteTrainerWorkoutGroups_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DeleteTrainerWorkoutGroups'
type TrainerRepository_DeleteTrainerWorkoutGroups_Call struct {
	*mock.Call
}
...
//  - ctx context.Context
//  - trainerUUID string
func (_e *TrainerRepository_Expecter) DeleteTrainerWorkoutGroups(ctx interface{}, trainerUUID interface{}) *TrainerRepository_DeleteTrainerWorkoutGroups_Call {
	return &TrainerRepository_DeleteTrainerWorkoutGroups_Call{Call: _e.mock.On("DeleteTrainerWorkoutGroups", ctx, trainerUUID)}
}

func (_c *TrainerRepository_DeleteTrainerWorkoutGroups_Call) Run(run func(ctx context.Context, trainerUUID string)) *TrainerRepository_DeleteTrainerWorkoutGroups_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *TrainerRepository_DeleteTrainerWorkoutGroups_Call) Return(_a0 error) *TrainerRepository_DeleteTrainerWorkoutGroups_Call {
	_c.Call.Return(_a0)
	return _c
}
...
func (_m *TrainerRepository) QueryTrainerWorkoutGroupWithDate(ctx context.Context, trainerUUID string, date time.Time) (trainer.WorkoutGroup, error) {
	ret := _m.Called(ctx, trainerUUID, date)

	var r0 trainer.WorkoutGroup
	if rf, ok := ret.Get(0).(func(context.Context, string, time.Time) trainer.WorkoutGroup); ok {
...
// TrainerRepository_QueryTrainerWorkoutGroupWithDate_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'QueryTrainerWorkoutGroupWithDate'
type TrainerRepository_QueryTrainerWorkoutGroupWithDate_Call struct {
	*mock.Call
}
...
//  - trainerUUID string
//  - date time.Time
func (_e *TrainerRepository_Expecter) QueryTrainerWorkoutGroupWithDate(ctx interface{}, trainerUUID interface{}, date interface{}) *TrainerRepository_QueryTrainerWorkoutGroupWithDate_Call {
	return &TrainerRepository_QueryTrainerWorkoutGroupWithDate_Call{Call: _e.mock.On("QueryTrainerWorkoutGroupWithDate", ctx, trainerUUID, date)}
}

func (_c *TrainerRepository_QueryTrainerWorkoutGroupWithDate_Call) Run(run func(ctx context.Context, trainerUUID string, date time.Time)) *TrainerRepository_QueryTrainerWorkoutGroupWithDate_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *TrainerRepository_QueryTrainerWorkoutGroupWithDate_Call) Return(_a0 trainer.WorkoutGroup, _a1 error) *TrainerRepository_QueryTrainerWorkoutGroupWithDate_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
